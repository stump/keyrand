...
class KeyItemRandomizer(object):
    ...
    def apply_randomization(self, rom):
        ...
        def replace_item(rom, addr, name):
            assert rom[addr] == KEY_ITEM_IDS[name]
        ...
        rom[0x1d787:0x1d7ff] = binascii.unhexlify('18f6211058cd493cafea26ccea2acc3e03ea29cc3e01ea28ccea25cc3cea24cc2130d7cbf621a0c3010f04cd2219cd29243e06ea1ed1cdcf2f21cac3116dcdcd551911ff57cd551921e4c3110758cd5519211558cd493ccdbe3a2130d7cbb6cb4f200cfa26cca72006211a58cd493c212a58cd493cc3d724')
        #At 0x1d78b, 70 (jump fixup)
        #rom[0x1d78b] = 0x70
        #At 0x1d7a3, ea25cc3cea24cc2130d7cbf621a0c3010f04cd2219cd29243e46cdcf2f21cac3116dcdcd551911ff57cd551921e4c3110758cd5519211558cd493ccdbe3acb4f20112130d7cbb6fa26cca72006211a58cd493c212a58cd493cc3d724 (put correct item in menu when you don't have voucher)
        #rom[0x1d7a3:0x1d7ff] = binascii.unhexlify('ea25cc3cea24cc2130d7cbf621a0c3010f04cd2219cd29243e46cdcf2f21cac3116dcdcd551911ff57cd551921e4c3110758cd5519211558cd493ccdbe3acb4f20112130d7cbb6fa26cca72006211a58cd493c212a58cd493cc3d724')
        #At 0x1d7b9, new item
        replace_item(rom, 0x1d7b9, 'BICYCLE')
        #At 0x98ed4, 50014bcf00e8505000 (so text from wcf4b is used)
        rom[0x98ed4:0x98edd] = binascii.unhexlify('50014bcf00e8505000')
        ...
        rom[0x9a83a:0x9a843] = binascii.unhexlify('50014bcf00e7505000')
        ...
        rom[0x9e086:0x9e08f] = binascii.unhexlify('50014bcf00e7505000')

        # Dome Fossil slot
        #At 0x49e40, 24 (pointer to adjusted text)
        rom[0x49e40] = 0x24
        #At 0x49eef, 3e29cdcf2f211f5fcd493ccdec35fa26cca7205e010129cd2e3ed2765fcd695f21f6d7cbf63e6dc3515f000000000000175e492050083e01ea3ccc3e2acdcf2f (put correct item in text when confirming picking up items)
        #rom[0x49eef:0x49f2f] = binascii.unhexlify('3e29cdcf2f211f5fcd493ccdec35fa26cca7205e010129cd2e3ed2765fcd695f21f6d7cbf63e6dc3515f000000000000175e492050083e01ea3ccc3e2acdcf2f')
        rom[0x49eef:0x49f2f] = binascii.unhexlify('3e29cd195f211f5fcd493ccdec35fa26cca7205e010129cd2e3ed2765fcd695f21f6d7cbf63e6dc3515fea1ed1c3cf2f175e492050083e01ea3ccc3e2acd195f')
        #At 0x49ef0, new item
        ...
        rom[0x49f4a:0x49f59] = binascii.unhexlify('21f6d7cbfe3e6eea4dcc3e11cd6d3e')
        #At 0x8096c, 50016dcd00e65700 (remove "the" before item name in text)
        rom[0x8096c:0x80974] = binascii.unhexlify('50016dcd00e65700')
        ...
        rom[0xa072d:0xa0736] = binascii.unhexlify('50014bcf00e7505000')
        ...
        rom[0x80987:0x8098f] = binascii.unhexlify('50016dcd00e65700')
        ...
        #At 0x1e637, 7c (pointer to adjusted text after the HM02 text)
        #At 0x8ce72, 50014bcf00e75050000000878cf6f87fa8b27f858b98e84f88b3bc (so text from wcf4b is used; adjust first text afterward to not have to shift everything after in way that minimizes length of this patch)
        #Instead of those two, at 0x1e631, 9954 (repoint text to S.S. Ticket text, which uses text from wcf4b)
        rom[0x1e631:0x1e633] = binascii.unhexlify('9954')
        ...
        rom[0x801a3:0x801ad] = binascii.unhexlify('5550015bcc00e7500500')
        ...
        rom[0x8ca45:0x8ca4e] = binascii.unhexlify('50014bcf00e7505000')

        # Town Map slot
        #At 0x19b69, 5f (give you the item after just beating Rival I, not after delivering parcel)
        rom[0x19b69] = 0x5f
        #At 0x19b7c, new item
        replace_item(rom, 0x19b7c, 'TOWN MAP')
        #At 0x94ca2, 4f50014bcf00e7505000 (remove "a" before item name in text)
        rom[0x94ca2:0x94cac] = binascii.unhexlify('4f50014bcf00e7505000')

        # Add randomizer info to the main menu screen.
        #At 0x05b20, 497c (reroute the menu's clear-screen call to new code)
        rom[0x05b20:0x05b22] = binascii.unhexlify('497c')
        #At 0x05ba8, 257d (reroute the menu's options screen to new code)
        rom[0x05ba8:0x05baa] = binascii.unhexlify('257d')
        ...
        rom[0x07c49:0x07d2b] = binascii.unhexlify('')
