...
class KeyItemRandomizer(object):
    ...
    def apply_randomization(self, rom):
        ...
        replace(rom, 0x1d787, '18f6211058cd493cafea26ccea2acc3e03ea29cc3e01ea28ccea25cc3cea24cc2130d7cbf621a0c3010f04cd2219cd29243e06ea1ed1cdcf2f21cac3116dcdcd551911ff57cd551921e4c3110758cd5519211558cd493ccdbe3a2130d7cbb6cb4f200cfa26cca72006211a58cd493c212a58cd493cc3d724')
        ...
        replace(rom, 0x9e086, '50014bcf00e7505000')

        # Dome Fossil slot
        #At 0x49e40, 24 (pointer to adjusted text)
        replace(rom, 0x49e40, '24')
        ...
        replace(rom, 0x49eef, '3e29cd195f211f5fcd493ccdec35fa26cca7205e010129cd2e3ed2765fcd695f21f6d7cbf63e6dc3515fea1ed1c3cf2f175e492050083e01ea3ccc3e2acd195f')
        #At 0x49ef0, new item
        ...
        replace(rom, 0x49f4a, '21f6d7cbfe3e6eea4dcc3e11cd6d3e')
        #At 0x8096c, 50016dcd00e65700 (remove "the" before item name in text)
        replace(rom, 0x8096c, '50016dcd00e65700')
        ...
        replace(rom, 0xa072d, '50014bcf00e7505000')
        ...
        replace(rom, 0x80987, '50016dcd00e65700')
        ...
        replace(rom, 0x07c49, '')
